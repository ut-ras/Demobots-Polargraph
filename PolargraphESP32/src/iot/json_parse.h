...
/* TODO for the polargraph, maybe instead of parsing like this we could use a thread,
with a char queue input, that constantly streams chars from the queue and parses all JSON
and coordinates into the polargraph input in one pass, just checking for the delimiters {,": */

//TODO better general JSON parser, this is old
